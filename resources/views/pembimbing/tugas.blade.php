...
@section('guru')
    <div class="container-fluid px-4 td-md-flex justify-content-md-center" style="text-align:center; display:flex;">
        <div class="container text-center" style="display: flex;">
            <div class="col-md">
                <a href="{{ route('guru.tambah_tugas') }}" type="button" class="btn btn-success mt-4 text-nowrap"
                    id="Tbtn">Tambah Tugas</a>
            </div>
        </div>
    </div>
            ...
            <tbody>
                @forelse ($tasks as $tsk)
                    <tr class="table-group-divider">
                        <td>{{ $tsk->judul }}</td>
                        <td>
                            <a href="{{ route('guru.pengumpulan', $tsk->id) }}" class="active" style="color: #231F20;"><i
                                    class="bi bi-file-earmark-text fs-4"></i></a>
                        </td>
                        <td>
                            <a href="{{ route('guru.detail', ['id' => $tsk->id]) }}" class="active" style="color: #231F20">
