...
@section('admin')
    <div class="container-fluid d-flex justify-content-center" id="container1" style="text-align:center;">
            ...
            <tbody>
                @forelse ($users as $u)
                    <tr class="table-group-divider">
                        <td>{{ $u->nama }}</td>
                        <td><a href="{{route('admin.jurnal', ['id' => $u->id])}}?export=pdf" style="color: #1D0CD1"><i class="bi bi-download fs-4"></i></a></td>
                        <td>
